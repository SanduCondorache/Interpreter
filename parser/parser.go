...
func (p *Parser) parseLetStatement() *ast.LetStatement {
	...
	stmt.Name = &ast.Id{Token: p.curToken, Value: p.curToken.Literal}
...
func (p *Parser) parseId() ast.Expression {
	return &ast.Id{Token: p.curToken, Value: p.curToken.Literal}
}
...
func (p *Parser) parseFunctionParameters() []*ast.Id {
	identifiers := []*ast.Id{}
	...
	ident := &ast.Id{Token: p.curToken, Value: p.curToken.Literal}
