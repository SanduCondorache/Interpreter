...
func (vm *VM) executeComparison(op code.Opcode) error {
	...
	switch op {
	case code.OpEqual:
		return vm.push(nativeBoolToBoolComparison(left == right))
...
func (vm *VM) executeIntegerComparison(op code.Opcode, left, right object.Object) error {
	...
	switch op {
	case code.OpEqual:
		return vm.push(nativeBoolToBoolComparison(leftValue == rightValue))
	case code.OpNotEqual:
		return vm.push(nativeBoolToBoolComparison(leftValue != rightValue))
...
func nativeBoolToBoolComparison(input bool) *object.Boolean {
	if input {
		return True
	}
	return False
